                  ...
                  {({ selected }) => (
                    ...
                    >
                      <span
                        className={
                          selected
                            ? "text-base font-  mx-auto "
                            : "text-base mx-auto ease-in-out duration-300 opacity-40 hover:opacity-100 "
                        }
                      >
                        {x.category}
                      </span>
                  ...
                  .map((x) => (
                    <div className="py-10 container gap-5 flex w-full  border-b">
                      ...
                      <div className="grow flex gap-2 flex-col">
                        <span className="text-sm uppercase montserrat font-normal">
                          DOCUMENT
                        </span>
                        <a
                          href={x.download.data.attributes.url}
                          ...
                          className="inline"
                        >
                          <span className="text-lg xl:text-xl block  hover:text-gray-300 font-bold">
                            {x.title}
                          </span>
                        </a>
                        <span className="uppercase montserrat font-normal">
                          {filetype(x.download.data.attributes.ext)}{" "}
                          {prettyBytes(x.download.data.attributes.size * 1000)}
                        </span>
                      </div>

                      <div className="flex-col shrink-0 min-w-[100px] flex justify-between">
                        <span className=" text-sm uppercase montserrat font-normal">
                          PUBLISHED
                        </span>
                        <span className=" uppercase montserrat font-normal">
