    ...
    <footer className="text-white bg-black body-font">
      ...
      <div className=" py-12 px-5 mx-auto container ">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="w-64 flex-shrink-0  text-left">
            <a className="flex title-font font-bold items-center md:justify-start justify-center text-gray-white">
              <svg
                width="231"
                height="33"
                viewBox="0 0 231 33"
            ...
            <p className="my-2 text-sm text-white">Spaces designed for life.</p>
            <span className="inline-flex sm:ml-auto sm:mt-2 gap-5 justify-center sm:justify-start">
              ...
              <a
                className="text-white"
                href="https://twitter.com/GableviewHomes/"
                target="_blank"
              >
                <svg
                  fill="currentColor"
          ...
          <div className="grid grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div className=" w-full ">
                <h2 className="font-bold text-white tracking-widest text-sm mb-3">
                  ABOUT
                </h2>
      ...
      <div className=" border-t bg-black border-gray-200">
        <div className="container mx-auto py-4 px-5 flex flex-wrap justify-between flex-col sm:flex-row">
          <p className="text-white soleilT text-sm text-left">
      ...
      {/* <div className="fixed bottom-0 z-[99999] right-0 p-6 w-8 h-8  bg-yellow-600 border flex justify-center items-center opacity-75">
