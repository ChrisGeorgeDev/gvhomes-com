      ...
      <div className="flex flex-col lg:flex-row ">
        <div className=" flex flex-col lg:text-upright justify-end w-7/12 2xl:w-4/12 ">
          <div className="ml-10 lg:ml-20 leading-none lg:leading-tight">
            <span className="text-5xl lg:text-8xl leading-[1.2em] block font-bold"  dangerouslySetInnerHTML={{__html:props.bold} }/>
            <span className="lg:text-8xl text-5xl leading-[1.2em] uppercase  block font-thin" dangerouslySetInnerHTML={{__html:props.thin} }/>
          </div>
        </div>
