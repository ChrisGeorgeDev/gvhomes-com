...
import ovstyle from "./OverlayMenu.module.css";
...
const Navbar = (props) => {
  ...
  return (
    ...
    >
      <div className="px-[24px] lg:px-[48px] xl:px-[96px] mx-auto flex flex-wrap p-5 flex-col md:flex-row justify-between items-center">
        <Link href="/">
        ...
        <div className="block order-last lg:hidden">
            ...
            >
              ...
              >
                <path
                  d="M36 8.99961V3.59961H0V8.99961H36ZM36 19.7996V14.3996H0V19.7996H36ZM36 30.5996V25.1996H0V30.5996H36Z"
                  fill="black"
                />
              </svg>
            </button>
        ...
        <nav className="md:ml-auto hidden lg:flex flex-wrap items-center text-base justify-center">
          ...
          <Link href="/about">
            <a className="mr-5 tracking-[.15em] text-black border-b-2 border-transparent hover:text-gray-600  hover:border-black">
              ABOUT
            </a>
          </Link>
          <Link href="/services">
        ...
        >
          <div className="block md:hidden">
            ...
            >
              ...
              >
                <path
                  d="M28 2.71929L25.18 0L14 10.7807L2.82 0L0 2.71929L11.18 13.5L0 24.2807L2.82 27L14 16.2193L25.18 27L28 24.2807L16.82 13.5L28 2.71929Z"
                  fill="white"
                />
              </svg>
            </button>
