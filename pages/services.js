            ...
            <main id="main" className="mb-auto">
                ...
                <section className="border-b">
                    <div className="container mx-auto px-5 sectionp">
                        ...
                        <p>
                            Gable View Homes is a full-service
                            real estate development firm
                            specializing in new construction
                            residential projects.
                        </p>

                        <div className="flex flex-col lg:flex-row xl:gap-24">
                ...
                <section className="border-b">
                    <div className="container mx-auto px-5 sectionp">
                        <h2>Project &
                            ...
                            Management</h2>
                        <p>
                            At Gable View Homes, we facilitate
                            the entire construction process
                            including design, preconstruction
                            and development, from project
                        ...
                        <div className="flex flex-col lg:flex-row xl:gap-24">
                            ...
                            <p>
                                As project and construction managers, we are able to provide end-to-end management solutions from pre-construction through  post-construction phases, to deliver projects successfully on time and on budget.                            </p>
                ...
                <section className="border-b">
                    <div className="container mx-auto px-5 sectionp">
                        ...
                        <p>
                            ...
                            from concept to launch, Gable View
                            Homes develops custom marketing
                        ...
                        <div className="flex flex-col lg:flex-row xl:gap-24">
                            ...
                            <p>
                                Our in-house marketing and sales team take a hands-on approach to marketing and selling new development projects. Our services include analyzing market conditions, determining competitive price points, creating sellable brands and delivering market strategies to pricing and marketing & sales operations. </p>
                ...
                <section className="border-b">
                    <div className="container mx-auto px-5 sectionp">
                        <h2>Custom Homes</h2>
                        <p>
                            Gable View Homes applies an
                            experienced approach to building
                            custom homes, residential additions
