...
//   console.log(community);
  ...
  return (
    <div>
      <Layout title={`${community.data[0].attributes.name} Community Resources `} description={`Ya get me - The next level`}>

      <ResourcesHero>
        <span className="mb-4 block ">COMMUNITY RESOURCES</span>
        <h1 className="text-left w-full  lg:w-7/12 2xl:w-6/12  text-2xl md:text-3xl lg:text-7xl  leading-[1.2em] font-bold block text-black">
